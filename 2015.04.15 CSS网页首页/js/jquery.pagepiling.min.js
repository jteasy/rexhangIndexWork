...
typeof c.navigation.tooltips){var rex = "→";"undefined"===typeof f&&(f="")}a.find("ul").append('<li data-tooltip="'+rex+'"><a href="#'+e+'"><span></span></a></li>')}a.find("span").css("border-color",c.navigation.bulletsColor)}function C(a,d){c.navigation&&(b("#pp-nav").find(".active").removeClass("active"),a?b("#pp-nav").find('a[href="#'+a+'"]').addClass("active"):b("#pp-nav").find("li").eq(d).find("a").addClass("active"))}function B(a){c.menu&&(b(c.menu).find(".active").removeClass("active"),
