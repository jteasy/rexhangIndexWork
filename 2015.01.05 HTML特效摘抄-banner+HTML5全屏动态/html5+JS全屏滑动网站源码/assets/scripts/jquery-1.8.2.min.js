...
;(function($) 
{
    ...
    ANCHOR_SCROLL.UTIL = {
        ...
        */
        smoothAnchor: function (anchorClass,select) 
        {
            $('a.'+anchorClass).bind('click', function (event) { 
                elementClick = $(this).attr("href");
                
                if(!$.browser.msie){
                   var destination = 0; 
                }
                if(elementClick == "#content1"){
                     
                    if(!$.browser.msie){
                        //newfusionworks._hidecontent2();
                    }else{
                ...
                // 检查如果不是ie 则调用
                if(!$.browser.msie && elementClick == "#content2"){
                      //newfusionworks._showcontent2();
                }
                
                $("html:not(:animated),body:not(:animated)").animate({ scrollTop: destination},{duration:1100});
				
				if(elementClick == "#content1" && !$.browser.msie){
					newfusionworks._hidecontent2(event);
				}else if(elementClick == "#content2" && !$.browser.msie){
					newfusionworks._showcontent2();
				}
                ...
                if(select == true){
                    ...
                    $(this).closest("nav").find("a").removeClass("nav_on");
                    $(this).addClass("nav_on");
                }
                
                newfusionworks._select_nav(elementClick);

                // 查询当前选项属于哪个 
                //var Obj = $(this).attr("href");
                //$(Obj+":not(:animated)").animate({ top: "30px" }, 1000);

                return false;
            })
        }
    }
    if(window.ANCHOR_SCROLL == undefined){
        window.ANCHOR_SCROLL = ANCHOR_SCROLL;
    }
})(jQuery);
...
$(document).ready(function(){
			  $(".clock_bg").mouseover(function(){$(".clock").fadeIn("normal");});
			  $(".clock_bg").mouseleave(function(){$(".clock").fadeOut("normal");});
...
var IMAGE_URL = "http://www.newfusion.cn/assets";
...
ph$ = {
	...
	scrollLveSell : function(o) {
		...
		tar.stop();
		tar2.stop();
		var max_num = $("#sell_order>figure").length;
		var width = 120;
		var left = 0;
		...
		if (o == "left") {
			...
			//console.log(Math.abs(pos.left)+width);
			//console.log(width*(max_num-5));
